...
public class RecruitController {
	...
	public Result referenceList(){
		List<Recruit> datas = recruitService.referenceList();
		return new Result(true,StatusCode.OK,"查询成功",datas);
	}
	...
	public Result newlist(){
		List<Recruit> datas = recruitService.newList();
		return new Result(true,StatusCode.OK,"查询成功",datas);
	}
